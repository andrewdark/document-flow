...
public class Citizen implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "CitizenStatusLink", joinColumns = @JoinColumn(name = "CitizenId"), inverseJoinColumns = @JoinColumn(name = "StatusId"))
	private Set<CitizenStatus> Status;

	/** Список социальных категорий гражданина */
	@ManyToMany
	@JoinTable(name = "CitizenCategoryLink", joinColumns = @JoinColumn(name = "CitizenId"), inverseJoinColumns = @JoinColumn(name = "CategoryId"))
